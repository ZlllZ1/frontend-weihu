      ...
      >
        <div class="py-1 px-2 flex items-center justify-between">
          ...
          <div>
            ...
            <div
              v-else-if="n.relatedItem.itemType === 'circle'"
              class="w-[76px] h-16 rounded-md border border-gray p-1 text-xs overflow-hidden"
            >
              <span v-html="n.relatedItem.detail.content"></span>
            </div>
            <div
              v-else-if="n.relatedItem.itemType === 'comment'"
              class="w-[76px] h-16 rounded-md border border-gray p-1 text-xs overflow-hidden"
            >
              <span>
                {{ n.relatedItem.detail.content }}
              </span>
            </div>
          </div>
        </div>
