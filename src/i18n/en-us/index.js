export default {
  message: {
    ...
    selectFriend: 'Select send friend',
    noFriends: 'no friends now',
    friend: 'friend',
    ...
    clearDraft: 'empty draft box',
    clearDraftSuccess: 'clear successfully',
    clearDraftFail: 'clear fail',
    owner: 'owner',
    ...
    dayOnline: 'online {day} days ago',
    hourOnline: 'online {hour} hours ago',
    ltHourOnline: 'online less than 1 hour ago',
    go: 'go',
    nobodyCare: 'nobody pays attention',
    noCollect: 'noCollect',
    noFollow: 'no follow',
    noFriend: 'no friend',
    online: 'online',
    ...
    loading: 'loading',
    viewCircleDetail: 'Click Moments to read Moments details',
    age: 'years old',
